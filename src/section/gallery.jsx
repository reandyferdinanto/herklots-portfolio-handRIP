                 ...
                 <Masonry
                    ...
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick3}
                        ...
                        <div className="card-image-1">
                            ...
                            <img src="./img/gallery/007-pf.gif" alt="portfolio-2" style={{ width: '400px' }}/>
                        </div>
                    </div>
                    <div className="col-lg-4 image-element-class de_modal" onClick={handleBtnClick}
                        data-aos="fade-up"
                  ...
                  <div className="LightboxGal">
                    ...
                    <div className="v-center w-100">
                      <div className="mainLightbox container">
                        <div className="row g-5">
                            <div className="col-lg-8">
                                <video className="pop" autoPlay loop  style={{width:"700px"}}>
                                  <source src="./img/gallery/jakarta-pf.mp4" type="video/mp4"/>
                                  Your browser does not support the video tag.
                                </video>
                            </div>

                            <div className="col-lg-4 de_project-info">
                                <h3>JAKARTA TOWN FESTIVAL TEASER ANIMATION, 2022</h3>
                                <p>Teaser trailer for Jakarta Town Festival using Blender and After Effects with assets given from Art Director</p>
                                ...
                                <div className="de_project-details">
                                    ...
                                    <div className="d-field">
                                        <i className="fa fa-file-text-o"></i>Type: <span>Video Animation</span>
                                    </div>
                                    <div className="d-field">
                                        <i className="fa fa-calendar-o"></i>Year: <span>2022</span>
                                    </div>
                  ...
                  <div className="LightboxGal">
                    ...
                    <div className="v-center w-100">
                      <div className="mainLightbox container">
                        <div className="row g-5">
                            <div className="col-lg-8">
                                <video className="pop" autoPlay loop  style={{width:"800px"}}>
                                  <source src="./img/gallery/007-pf.mp4" type="video/mp4"/>
                                  Your browser does not support the video tag.
                                </video>
                            </div>

                            <div className="col-lg-4 de_project-info">
                                <h3>07 NO TIME TO DIE OPENING TITLE REDESIGN, 2022</h3>
                                <p>Portraits of creatives in their home studios and local environs.</p>
